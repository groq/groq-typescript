...
export interface ChatCompletion {
  ...
  /**
   * The service tier used for the request. Deployments running in strict OpenAI
   * compatibility report Groq-specific tiers as `default`.
   */
  service_tier?: 'auto' | 'on_demand' | 'flex' | 'performance' | 'default' | null;
...
export interface ChatCompletionMessage {
  ...
  /**
   * A safety refusal the model generated instead of content. Null when the model did
   * not refuse.
   */
  refusal?: string | null;
...
export interface ChatCompletionCreateParamsBase {
   ...
   */
  reasoning_effort?: 'none' | 'default' | 'minimal' | 'low' | 'medium' | 'high' | 'xhigh' | 'max' | null;
