...
This can also be useful if you are getting the wrong TypeScript types for `Response` - more details [here](https://github.com/groq/tree/stainless/src/_shims#readme).
...
We are keen for your feedback; please open an [issue](https://www.github.com/groq/groq-sdk-node/issues) with questions, bugs, or suggestions.
